...
BINDINGS = [
    ...
    ("quest_emitted_cx", "results/noise/quest_operational_comparison.json",
     "/quest_preparation/quest_emitted_cx_count"),
    ("k3_bE_coverage", "results/baselines_k3_quest.json", "/cross_check_coverage"),
    ("k3_variants_agree", "results/baselines_k3_quest.json", "/variants_agree"),
